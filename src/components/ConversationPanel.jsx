...
const ConversationPanel = ({
  ...
  return (
    <>
      ...
      <div className="fade-in-up" style={{ position: 'fixed', top: 0, left: 0, bottom: 0, width: '380px', backgroundColor: styles.panel, borderRight: `1px solid ${styles.border}`, zIndex: 201, display: 'flex', flexDirection: 'column', boxShadow: '4px 0 20px rgba(0,0,0,0.2)' }}>
        {/* Header */}
