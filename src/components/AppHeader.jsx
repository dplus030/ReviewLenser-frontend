...
const AppHeader = ({ styles, isLight, theme, setTheme, t, isMobile, isPro, currentUser, usageCount, maxFreeUses, handleUpgradeClick, handleLogout, setShowAuth, setIsSignUpMode, setView, onShowHistory, onNewChat, onShowWishlist, wishlistCount }) => (
